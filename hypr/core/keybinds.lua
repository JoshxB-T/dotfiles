...
hl.bind(mainMod .. " + SHIFT + l", hl.dsp.exec_cmd(apps.lock))
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd(apps.scrnshotO))
hl.bind(mainMod .. " + SHIFT + I", hl.dsp.exec_cmd(apps.scrnshotR))
